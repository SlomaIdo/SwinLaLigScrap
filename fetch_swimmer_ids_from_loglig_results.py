...
def main():
    url = "https://loglig.com:2053/LeagueTable/AthleticsDisciplineResults/67364?isModal=false"
    ...
    # Write to CSV
    with open("swimmers_from_loglig_results_67364.csv", "w", encoding="utf-8", newline="") as f:
        writer = csv.writer(f)
    ...
    print(f"Found {len(swimmer_rows)} swimmer IDs. Wrote to swimmers_from_loglig_results_67364.csv.")
